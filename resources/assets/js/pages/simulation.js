...
$('#duration').click(function () {
    var retirementage = parseInt($('#retirement-age option:selected').data('value')),
        age = parseInt($('#age option:selected').data('value')),
        duration = retirementage - age;
    $(this).val(duration + ' tahun').attr('data-value', duration);
});
$('#duration-after').click(function () {
    var lifeexpectancy = parseInt($('#life-expectancy option:selected').data('value')),
        retirementage = parseInt($('#retirement-age option:selected').data('value')),
