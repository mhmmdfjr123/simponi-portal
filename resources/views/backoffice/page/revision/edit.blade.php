...
@section('content')
    <ol class="breadcrumb page-breadcrumb">
        <!-- Auto Breadcrumbs -->
        <li class="active" data-active-menu="#menu-page-revision"><a href="#">Ubah Halaman</a></li>
    </ol>
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-xs-12 width-md-auto width-lg-auto width-xl-auto pull-md-right">
                <a href="{{ route('backoffice.page.revision.index') }}" class="btn btn-primary btn-block" style="width: 100%;"><span class="btn-label-icon left fa fa-arrow-left"></span>Kembali</a>
            </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                @if(isset($originalPageId))
                    <input type="hidden" name="page_id" value="{{ $originalPageId }}" />
                @else
        ...
        <div class="col-md-4">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="control-label">Alasan Perubahan Halaman:</label>
