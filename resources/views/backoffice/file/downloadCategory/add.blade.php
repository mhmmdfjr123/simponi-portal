...
<script type="text/javascript">
    require(['jquery', 'px-libs/toastr', 'px-bootstrap/button', 'px/plugins/px-validate'],
        function($, toastr) {
...
<div class='fbox-container'>
    <form id="ajax-form" name="ajax-form" class="form" action="{{ url('backoffice/file/download/category/submit') }}" enctype="multipart/form-data" method="post" role="form">
