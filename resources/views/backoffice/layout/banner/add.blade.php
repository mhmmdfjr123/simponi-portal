    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                <input type="text" name="name" maxlength="300" class="form-control required input-lg" placeholder="Nama Banner" />
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            </div>

            <div class="form-group">
                <input type="text" name="hyperlink" maxlength="500" class="form-control url" placeholder="Hyperlink (Optional)" />
                <p class="help-block">Setiap banner yang di klik akan diarahkan sesuai dengan hyperlink ini.</p>
            </div>

            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Gambar</span>
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <label class="control-label">Waktu Mulai Publikasi</label>
