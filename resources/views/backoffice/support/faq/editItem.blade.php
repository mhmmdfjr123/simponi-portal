        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <input type="text" name="question" maxlength="300" class="form-control required input-lg" placeholder="Pertanyaan" value="{{ $obj->question }}" />
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control tinymce" name="answer" id="answer" rows="10">{{ $obj->answer }}</textarea>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div style="margin-top: 10px">
                                    <label for="switcher-success" class="switcher switcher-success">
                                        <input id="switcher-success" <?php if($obj->status == 'Y')echo 'checked="checked"' ?> type="checkbox" name="status" value="Y">
