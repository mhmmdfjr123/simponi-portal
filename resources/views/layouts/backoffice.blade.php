...
<head>
    ...
    <!-- Demo assets -->
    <link href="{{ asset('theme/backoffice/demo/demo.css') }}" rel="stylesheet" type="text/css">
    <!-- / Demo assets -->
...
<nav class="px-nav px-nav-left" id="px-demo-nav">
    ...
    <ul class="px-nav-content">
        <li class="px-nav-box p-a-3 b-b-1" id="demo-px-nav-box">
            ...
            <img src="../../dist/demo/avatars/1.jpg" alt="" class="pull-xs-left m-r-2 border-round" style="width: 54px; height: 54px;">
        ...
        <li class="px-nav-item">
            <a href="../../color-generator/index.html"><i class="px-nav-icon ion-aperture"></i><span class="px-nav-label">Color Generator</span></a>
        </li>
        <li class="px-nav-item">
        ...
        <ul class="nav navbar-nav navbar-right">
                ...
                <div class="dropdown-menu p-a-0" style="width: 300px;">
                    <div id="navbar-messages" style="height: 280px; position: relative;">
                        <div class="widget-messages-alt-item">
                            <img src="../../dist/demo/avatars/2.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="../../dist/demo/avatars/3.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="../../dist/demo/avatars/4.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="../../dist/demo/avatars/5.jpg" alt="" class="widget-messages-alt-avatar">
                            <a href="#" class="widget-messages-alt-subject text-truncate">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="../../dist/demo/avatars/1.jpg" alt="" class="px-navbar-image">
