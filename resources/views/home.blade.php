...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3 text-center">
                ...
                <div class="col-sm-12">
                    <iframe class="col-sm-12" src="http://www.youtube.com/embed/zCW2UhdTarQ"></iframe>
    ...
    <section class="bg-secondary" id="about">
        <a class="abovefold page-scroll" href="#about">Apa itu BNI Simponi?<span class="fa fa-angle-double-down"></span></a>
        <div class="container">
            <div class="row">
