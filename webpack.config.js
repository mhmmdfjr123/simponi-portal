 ...
 *
 * This file is custom laravel mix configuration
 * (this file will be removed, if Laravel Mix has been supported to disable url resolving in LESS Transpilation)
 *
 */
...
if (Mix.preprocessors) {
    Mix.preprocessors.forEach(toCompile => {
        ...
        let urlOptions = sourceMap ? '&url=false' : '?url=false';
        ...
        module.exports.module.rules.push({
            ...
            use: extractPlugin.extract({
                ...
                use: [
                    { loader: 'css-loader' + sourceMap + urlOptions },
                    { loader: 'postcss-loader' + sourceMap + urlOptions }
                ].concat(
                    toCompile.type == 'sass' ? [
